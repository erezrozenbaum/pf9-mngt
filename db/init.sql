...
-- -------------------------------------------------------------------------
-- Rightsizing Recommendations (v2.6.0)
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- SLA Defense Alerts (v2.16.0)
-- Proactive SLA-risk alerts derived from SLA commitments + open insights.
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- AI Incident Triage briefs (v2.18.0)
-- Stores AI-generated incident analysis/recommendations and operator actions.
-- -------------------------------------------------------------------------
...
-- CLEA navigation item (Admin Tools group)
INSERT INTO nav_items (nav_group_id, key, label, icon, route, resource_key, sort_order)
VALUES (
...
INSERT INTO clea_policies (event_type, condition_expr, runbook_name, approval_mode, enabled, created_by) VALUES
    ('drift.resource_orphaned', '{}', 'orphan_resource_cleanup', 'single_approval', true, 'system'),
    ('quota.warning',           '{}', 'quota_threshold_check',   'auto',             true, 'system')
ON CONFLICT DO NOTHING;
