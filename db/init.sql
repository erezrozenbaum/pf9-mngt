...
(
    ...
    'vm', 'medium', true,
    '{"type":"object","properties":{"server_id":{"type":"string","description":"ID of the VM to diagnose"},"auto_restart":{"type":"boolean","default":false,"description":"Restart the VM if issues found"},"restart_type":{"type":"string","enum":["soft","hard","guest_os"],"default":"soft","description":"Restart method"}},"required":["server_id"]}'
),
(
    ...
    'vm', 'low', true,
    '{"type":"object","properties":{"server_id":{"type":"string","description":"ID of the VM to snapshot"},"reference_id":{"type":"string","default":"","description":"Ticket or incident reference ID"},"tag_prefix":{"type":"string","default":"Pre-T2-escalation","description":"Tag prefix for the snapshot"}},"required":["server_id"]}'
),
(
    ...
    'quota', 'low', false,
    '{"type":"object","properties":{"quota_threshold_pct":{"type":"integer","default":80,"description":"Quota usage % to flag"},"price_per_vcpu":{"type":"number","default":15.0,"description":"Monthly price per vCPU ($)"},"price_per_gb_ram":{"type":"number","default":5.0,"description":"Monthly price per GB RAM ($)"},"include_flavor_analysis":{"type":"boolean","default":true,"description":"Check for small/old flavors"},"include_image_analysis":{"type":"boolean","default":true,"description":"Check for old/deprecated images"}}}'
),
(
...
INSERT INTO runbook_approval_policies (runbook_name, trigger_role, approver_role, approval_mode) VALUES
    ...
    ('upgrade_opportunity_detector','operator',   'admin',  'auto_approve'),
    ...
    ('security_compliance_audit',   'operator',   'admin',  'auto_approve'),
    ('security_compliance_audit',   'admin',      'admin',  'auto_approve'),
