...
**Current version:** [v1.82.33](CHANGELOG.md) — March 2026
...
- Removed `TrustedHostMiddleware` from `monitoring/main.py` — it blocked Kubernetes kubelet health probes, causing `/health` 400s and a pod restart loop.
