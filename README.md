...
[![Version](https://img.shields.io/badge/version-1.83.42-blue.svg)](CHANGELOG.md)
...
**[v1.83.42](CHANGELOG.md)** — UI fix: dark-mode logo no longer inverted/corrupted (white pill wrapper replaces CSS filter); sidebar hard border replaced with inset shadow for unified light-mode chrome.
...
**Project Status**: Production Ready | **Version**: 1.83.42 | **Last Updated**: April 2026
