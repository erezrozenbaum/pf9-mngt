...
[![Version](https://img.shields.io/badge/version-1.83.43-blue.svg)](CHANGELOG.md)
...
**[v1.83.43](CHANGELOG.md)** — UI fix: dynamic section title in app-shell header (replaces static "PF9 Management Portal"); redundant "Operations Dashboard" h1 removed from dashboard; demo banner repositioned above main layout for correct header/sidebar height alignment.
...
**Project Status**: Production Ready | **Version**: 1.83.43 | **Last Updated**: April 2026
